  ...
  const plans = [
    {
      ...
      price: "0",
      period: "forever",
      description: "Quick, occasional sharing with short‑lived links.",
      icon: <CheckCircle className="h-6 w-6 text-emerald-500" />,
      features: [
        "Send up to 2 GB per transfer",
    ...
    },
    {
      ...
      description: "For creatives and pros who need bigger sends and control.",
    ...
    },
    {
      ...
      description: "For small teams with shared storage and governance.",
      icon: <Users className="h-6 w-6 text-purple-500" />,
      features: [
        "Everything in Pro",
        "Shared team storage (pooled)",
        "Roles & permissions",
        "Centralized billing",
    ...
    },
    {
      ...
      description: "Security, compliance and scale for larger companies.",
      icon: <Crown className="h-6 w-6 text-yellow-500" />,
      features: [
        "Everything in Teams",
        "Custom transfer limits & storage",
        "SSO/SAML, SCIM provisioning",
        "DLP & compliance (SOC 2/GDPR)",
        "Custom retention policies",
        "Advanced audit logs",
        "Dedicated CSM & SLA",
        "Full custom branding (domains)"
      ],
      popular: false,
      cta: "Contact Sales",
      href: "/contact",
      color: "from-yellow-50 to-yellow-100/50",
      note: "Scales with your org"
    }
  ]
